...
public class addAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(483, 400));
    ...
    private void adminsubmitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adminsubmitbtnActionPerformed
        ...
        try{
            ...
            String adminMail=adminemail.getText();
            String adminPass=adminpass.getText();
            String sql;
            sql = "INSERT INTO admin(email,password,name) VALUES('"+adminMail+"','"+adminPass+"','"+adminName+"');";
